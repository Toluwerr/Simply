...
- [x] read 922 articles all-time (now 722) - DONE (iteration 432)
- [x] read 950 articles all-time (now 750) - DONE (iteration 432)
...
25% of the time, exploit the rest.

| strategy | tries | avg reward |
|---|---|---|
| survey | 1 | 6.00 |
| deep_dive | 1 | 6.00 |
| drill | 7 | 4.86 |
